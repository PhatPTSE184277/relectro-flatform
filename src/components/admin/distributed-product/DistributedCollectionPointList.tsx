...
import DistributedCollectionPointShow from './DistributedCollectionPointShow';
import DistributedCompanySkeleton from './DistributedCompanySkeleton';

interface DistributedCollectionPointListProps {
    points: any[];
    loading: boolean;
    onViewProducts: (point: any) => void;
}

const DistributedCollectionPointList: React.FC<DistributedCollectionPointListProps> = ({ points, loading, onViewProducts }) => {
    return (
                            ...
                            <tbody>
                                {loading ? (
                                    ...
                                    points.map((point, idx) => (
                                        <DistributedCollectionPointShow
...
export default DistributedCollectionPointList;
