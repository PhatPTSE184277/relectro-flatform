...
interface ImportCollectionPointModalProps {
    open: boolean;
    onClose: () => void;
    onImport: (file: File) => Promise<boolean>;
}

const ImportCollectionPointModal: React.FC<ImportCollectionPointModalProps> = ({
    open,
    onClose,
    onImport
}) => {
            ...
            <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden z-10 max-h-[90vh] animate-fadeIn">
                <div className="flex justify-between items-center p-6 border-b border-gray-100 bg-linear-to-r from-primary-50 to-primary-100">
                    <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">Chọn file Excel để tạo mới đơn vị thu gom</p>
                    </div>
                    <button
                        onClick={handleClose}
...
export default ImportCollectionPointModal;
