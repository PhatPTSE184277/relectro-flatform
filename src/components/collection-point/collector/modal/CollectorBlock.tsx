...
const CollectorBlock: React.FC<CollectorBlockProps> = ({ open, onClose, onConfirm, loading }) => {
    if (!open) return null;
            ...
            <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden z-10 animate-fadeIn">
                <div className="flex justify-between items-center p-6 border-b border-gray-100 bg-linear-to-r from-red-50 to-primary-100">
                    <h2 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                        ...
                        Xác nhận khóa nhân viên thu gom
                    </h2>
                    <button
                        onClick={onClose}
                        disabled={loading}
                ...
                <div className="p-6 bg-gray-50">
                    <p className="text-gray-700 text-base">
                        Bạn có chắc chắn muốn <span className="font-semibold text-red-600">khóa</span> nhân viên thu gom này không?
                    </p>
                </div>
