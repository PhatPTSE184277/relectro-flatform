...
const ScanPackageModal: React.FC<ScanPackageModalProps> = ({
    ...
    return (
        <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4'>
            ...
            {/* Modal container */}
            <div className={`relative w-full ${scannedPackage ? 'max-w-6xl' : 'max-w-xl'} bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden z-10 max-h-[92vh] animate-fadeIn transition-all duration-300`}>
                {/* Header */}
