...
const RegisterCategoryModal: React.FC<RegisterCategoryModalProps> = ({
  open,
  onClose,
  onSuccess,
  companyId
  ...
  return (
    <>
      <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4'>
        ...
        <div className='relative w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden z-10 max-h-[90vh] flex flex-col'>
